		...
		return (
			<section className='form__section form__section-details'>
				...
				<input
					...
					name='itemName'
					defaultValue={this.props.currentItem ? this.props.currentItem.itemName : ''}
				/>
				...
				<textarea
					...
					name='description'
					defaultValue={this.props.currentItem ? this.props.currentItem.description : ''}
				...
				<select className={this.state.showErrors.category ? 'form__input-radius form__input-drop error' : 'form__input-radius form__input-drop'} name='category' defaultValue={this.props.currentItem ? this.props.currentItem.category : ''} >
